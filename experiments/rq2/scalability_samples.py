...
if __name__ == "__main__":
    ...
    os.makedirs(f"results/RQ2/{args.method}/scalability_samples/{args.dataset}/{args.casestudy}", exist_ok=True)
    result_path = f"results/RQ2/{args.method}/scalability_samples/{args.dataset}/{args.casestudy}/{args.seed}.csv"
